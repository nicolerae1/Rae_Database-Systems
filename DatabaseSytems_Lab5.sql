...
--Number 6
--for city selection, could be from either customers or agents (same info)
...
--Number 7
--without the use of count/group by
select c.name, c.city, p.quantity
